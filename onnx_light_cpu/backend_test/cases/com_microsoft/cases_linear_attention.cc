...
void RegisterCpuMicrosoftLinearAttentionCases(std::vector<TestCase> &registry, TestMode mode) {
  ...
  for (const LinearAttentionCase &test_case :
       {LinearAttentionCase{"linear", 1, 3, 2, 2, 2, 4, 3, "linear", false, false, false,
        ...
        LinearAttentionCase{"gqa_gated_delta", 2, 3, 4, 2, 2, 4, 3, "gated_delta", true, true, true,
                            rt_ns::DataType::FLOAT, 4152},
        LinearAttentionCase{"inverse_shared_gated_delta", 2, 3, 1, 1, 2, 4, 3, "gated_delta", true,
                            true, false, rt_ns::DataType::FLOAT, 4153},
        LinearAttentionCase{"delta_shared_beta", 1, 3, 2, 2, 2, 4, 3, "delta", false, false, true,
                            rt_ns::DataType::FLOAT, 4154},
        LinearAttentionCase{"empty_sequence_past", 1, 0, 1, 1, 2, 4, 3, "gated_delta", true, true,
                            true, rt_ns::DataType::FLOAT, 4155},
