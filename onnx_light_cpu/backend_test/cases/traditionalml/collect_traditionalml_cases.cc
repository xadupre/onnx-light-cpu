...
void CollectCpuTraditionalMlTestCases(std::vector<TestCase> &registry, const std::string &op_type,
                                      TestMode mode) {
  ...
  static const OpRegisterModeMap kEntries = {
      {"TreeEnsemble", &RegisterCpuTreeEnsembleCases},
      {"TreeEnsembleClassifier", &RegisterCpuTreeEnsembleClassifierCases},
      {"TreeEnsembleRegressor", &RegisterCpuTreeEnsembleRegressorCases},
  };
