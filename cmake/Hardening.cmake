...
# as an opt-in set of compile and link flags applied to every onnx-light-cpu
# target.
#
# Enable with ``-DONNX_HARDENING=ON``. Each flag is probed and silently skipped
# when the active toolchain does not support it.
#
# The macro ``onnx_light_apply_hardening(<target>)`` is the public entry point.
# It is a no-op when ONNX_HARDENING is OFF.
  ...
  if(NOT _onnx_light_qspectre_index EQUAL -1)
    ...
    if(_onnx_light_msvc_spectre_lib_dir)
      ...
      message(WARNING
              ...
              "CRT/STL libraries could not be located.")
    endif()
  endif()
else()
