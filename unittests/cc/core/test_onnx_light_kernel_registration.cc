...
TEST(KernelRegistration, CollectionReportsEveryActualRegistration) {
  ...
  const std::vector<KernelRegistration> expected = {
      ...
      {"ai.onnx",
       "LinearAttention",
       sym_ns::Device::kCPU,
       "onnx_light_cpu::LinearAttention",
       {rt_ns::DataType::FLOAT, rt_ns::DataType::FLOAT16, rt_ns::DataType::BFLOAT16},
       27,
       std::nullopt},
      {"ai.onnx",
      ...
      {"ai.onnx",
       ...
       {rt_ns::DataType::FLOAT,        rt_ns::DataType::DOUBLE,
        ...
        rt_ns::DataType::INT16,        rt_ns::DataType::UINT16,
        rt_ns::DataType::INT32,        rt_ns::DataType::UINT32,
        rt_ns::DataType::INT64,        rt_ns::DataType::UINT64,
        rt_ns::DataType::BOOL,         rt_ns::DataType::STRING,
        rt_ns::DataType::FLOAT8E4M3FN, rt_ns::DataType::FLOAT8E4M3FNUZ,
        rt_ns::DataType::FLOAT8E5M2,   rt_ns::DataType::FLOAT8E5M2FNUZ,
        rt_ns::DataType::FLOAT8E8M0,   rt_ns::DataType::INT4,
        rt_ns::DataType::UINT4,        rt_ns::DataType::INT2,
        rt_ns::DataType::UINT2,        rt_ns::DataType::FLOAT4E2M1,
        rt_ns::DataType::FLOAT6E2M3,   rt_ns::DataType::FLOAT6E3M2},
       std::nullopt,
       std::nullopt},
      {"ai.onnx",
       "Gather",
       sym_ns::Device::kCPU,
       "onnx_light_cpu::Gather",
       {rt_ns::DataType::FLOAT, rt_ns::DataType::DOUBLE, rt_ns::DataType::FLOAT16,
        rt_ns::DataType::BFLOAT16, rt_ns::DataType::INT8, rt_ns::DataType::UINT8,
        rt_ns::DataType::INT16, rt_ns::DataType::UINT16, rt_ns::DataType::INT32,
        rt_ns::DataType::UINT32, rt_ns::DataType::INT64, rt_ns::DataType::UINT64,
        rt_ns::DataType::BOOL, rt_ns::DataType::FLOAT8E4M3FN, rt_ns::DataType::FLOAT8E4M3FNUZ,
        rt_ns::DataType::FLOAT8E5M2, rt_ns::DataType::FLOAT8E5M2FNUZ, rt_ns::DataType::FLOAT8E8M0},
       std::nullopt,
       std::nullopt},
      {"ai.onnx",
       "ScatterND",
       sym_ns::Device::kCPU,
       "onnx_light_cpu::ScatterND",
       {rt_ns::DataType::FLOAT, rt_ns::DataType::DOUBLE, rt_ns::DataType::FLOAT16,
        rt_ns::DataType::BFLOAT16, rt_ns::DataType::INT8, rt_ns::DataType::UINT8,
        rt_ns::DataType::INT16, rt_ns::DataType::UINT16, rt_ns::DataType::INT32,
        rt_ns::DataType::UINT32, rt_ns::DataType::INT64, rt_ns::DataType::UINT64,
      ...
      {"ai.onnx",
       ...
       sym_ns::Device::kCPU,
       "onnx_light_cpu::SimplifiedLayerNormalization",
       {rt_ns::DataType::FLOAT, rt_ns::DataType::DOUBLE, rt_ns::DataType::FLOAT16,
        rt_ns::DataType::BFLOAT16},
       1,
       std::nullopt},
...
TEST(KernelRegistration, MicrosoftImplementationPolicySelectsOneCompleteFamily) {
  ...
  EXPECT_EQ(microsoft_names(optimized),
            (std::vector<std::pair<std::string, std::string>>{
                ...
                {"MatMulNBits", "onnx_light_cpu::MatMulNBits"},
                {"SkipSimplifiedLayerNormalization",
                 "onnx_light_cpu::SkipSimplifiedLayerNormalization"}}));
